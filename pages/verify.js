                ...
                <form className="space-y-6">
                    ...
                    <div>
                        <button
                            ...
                            disabled={isVerifying || isLoading || !walletAddress || !amount}
                            className={`w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${isVerifying || isLoading || !walletAddress || !amount
