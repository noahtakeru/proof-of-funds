 ...
 */
function encryptProof(proofData, accessKey) {
  try {
 ...
 */
function decryptProof(encryptedProof, accessKey) {
  try {
    ...
    const decryptedBytes = CryptoJS.AES.decrypt(encryptedProof, accessKey);
 ...
 */
function verifyAccessKey(accessKey, hashedKey) {
