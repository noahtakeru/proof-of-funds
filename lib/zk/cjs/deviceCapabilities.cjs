/**
 * deviceCapabilities.cjs - Detects device capabilities for ZK operations (CommonJS)
 * 
...
/**
 * Get device capabilities for use in memory management and other operations
 * 
