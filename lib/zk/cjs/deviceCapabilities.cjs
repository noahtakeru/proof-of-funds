/**
 * Device Capabilities Detection Module (CommonJS Version)
 * 
...
const { SystemError, ErrorCode, ErrorSeverity } = require('./zkErrorHandler.cjs');
 ...
 */
function shouldUseServerSide(capabilities, operationType = 'standard') {
 ...
 */
function getMemoryRequirements(operationType = 'standard') {
...
// Export all module functions and constants
module.exports = {
  detectCapabilities,
  detectWebAssembly,
  detectWebCrypto,
