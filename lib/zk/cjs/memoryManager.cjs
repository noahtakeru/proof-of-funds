...
const { getDeviceCapabilities } = require('./deviceCapabilities.cjs');
 ...
 */
const checkMemoryAvailability = (requiredMemoryMB) => {
 ...
 */
const runWithMemoryControl = async (fn, requiredMemoryMB, options = {}) => {
...
/**
 * Default export for memoryManager module
 * Contains all functions for memory management
 * 
