...
/**
 * Import dependencies using consistent destructuring pattern for standardization
 */
...
/**
 * CommonJS exports with a well-documented structure
 * All functions are exported as properties on the module.exports object
 */
const zkRecoverySystem = {
  withRetry,
  createCheckpoint,
  getCheckpoint,
  removeCheckpoint,
