...
async function runHealthChecks() {
    ...
    try {
        // Note: EnvironmentDetector doesn't have a detect() method,
        // we need to use detectEnvironment() and detectFeatures() 
        const envType = envDetector.detectEnvironment();
        const features = envDetector.detectFeatures();
