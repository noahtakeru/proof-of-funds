 ...
 */
export function generateReferenceId(walletAddress, proofType) {
 ...
 */
export function formatReferenceId(referenceId) {
 ...
 */
export function parseReferenceId(formattedId) {
 ...
 */
export async function referenceIdExists(referenceId) {
