/**
 * @fileoverview ZK Custom Error Handling Module - CommonJS Version
 * 
...
// Extra class to satisfy test requirements
class CryptoError extends ZKError {
    constructor(message, options = {}) {
        super(message, {
            ...options,
            code: options.code || 'ZK_CRYPTO_ERROR'
        });
    }
}
