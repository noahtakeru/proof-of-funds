/**
 * Security Detector Factory (CommonJS version)
 * 
...
const { ReplayAttackDetector } = require('./ReplayAttackDetector.cjs');
const { MalleabilityDetector } = require('./MalleabilityDetector.cjs');
const { InputValidationDetector } = require('./InputValidationDetector.cjs');
const { VerificationBypassDetector } = require('./VerificationBypassDetector.cjs');
const { ImplementationVulnerabilityDetector } = require('./ImplementationVulnerabilityDetector.cjs');
const { AnomalyDetector, NotificationChannelType } = require('./AnomalyDetector.cjs');
