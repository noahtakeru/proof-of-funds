...
/**
 * Notification channel for anomaly alerts
 * @typedef {Object} NotificationChannel
 * @property {string} id - Unique channel identifier
 * @property {string} name - Human-readable channel name
 * @property {NotificationChannelType} type - Channel type
 * @property {Object} config - Channel configuration
 * @property {boolean} active - Whether the channel is active
 */
...
export class AnomalyDetector extends SecurityRule {
     ...
     * 
     * @param {NotificationChannel} channel - The notification channel to add
