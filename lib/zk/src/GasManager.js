...
/**
 * Calculate percentage of gas savings between original and optimized gas usage
 * @function calculateGasSavings
 * @param {number} originalGas - The original gas usage amount
 * @param {number} optimizedGas - The optimized gas usage amount
 * @returns {number} Percentage of gas saved (0-100)
 * @throws {InputError} If gas values are not numbers
 * @throws {SystemError} If calculation fails due to system issues
 * @example
 * // Calculate 25% gas savings
 * const savings = calculateGasSavings(1000, 750); // Returns 25
 */
