...
const ZKErrorFactory = {
  ...
  createFromError: (error, options = {}) => {
    return fromError(error, options);
  },
...
// Create the exports object that will be used by both formats
const exportObj = {
  ErrorSeverity,
  ErrorCategory,
  ErrorCode,
...
// Pure ESM export - we're in a .js file with type:module in package.json
