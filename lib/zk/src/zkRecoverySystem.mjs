...
/**
 * Import dependencies using explicit named imports for better standardization
 */
import memoryManagerModule from './memoryManager.js';
const memoryManager = memoryManagerModule.default || memoryManagerModule;

import errorHandlerModule from './zkErrorHandler.mjs';
const {
  ErrorCode,
  ZKError,
  SystemError,
...
const zkErrorHandler = errorHandlerModule;

// Get error logger using the getter function to break circular dependency
const zkErrorLogger = getErrorLogger();

import secureStorageModule from './secureStorage.js';
const secureStorage = secureStorageModule.default || secureStorageModule;
...
/**
 * Default export for compatibility and ease of use
 */
export default {
  withRetry,
  createCheckpoint,
