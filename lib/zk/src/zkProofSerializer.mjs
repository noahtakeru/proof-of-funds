...
// Import error handling components using ESM syntax
import {
  InputError,
  ProofError,
...
/**
 * The current proof format version used by the serialization system
 * @constant {string}
 */
export const PROOF_FORMAT_VERSION = '1.0.0';

/**
 * The library version, used for compatibility tracking
 * @constant {string}
 */
export let LIBRARY_VERSION = '1.0.0';
try {
 ...
 * @typedef {Object} ProofTypes
 * @property {string} STANDARD - Standard proof for basic balance verification
 * @property {string} THRESHOLD - Threshold proof for minimum balance verification
 * @property {string} MAXIMUM - Maximum proof for specific amount verification
 */
export const PROOF_TYPES = {
  /** Standard proof for basic balance verification */
  STANDARD: 'standard',
  /** Threshold proof for minimum balance verification */
  THRESHOLD: 'threshold',
  /** Maximum proof for specific amount verification */
  MAXIMUM: 'maximum'
};
 ...
 */
export function serializeProof(proof, publicSignals, options) {
 ...
 */
export function extractProofForVerification(proofContainer) {
  try {
 ...
 */
export function isValidProof(proofContainer) {
  try {
    // Deserialize if string
    const container = typeof proofContainer === 'string'
      ? deserializeProof(proofContainer)
 ...
 */
export function getProofMetadata(proofContainer) {
  try {
    // Deserialize if string
    const container = typeof proofContainer === 'string'
      ? deserializeProof(proofContainer)
 ...
 * This default export is maintained for backward compatibility
 */
export default {
  PROOF_TYPES,
