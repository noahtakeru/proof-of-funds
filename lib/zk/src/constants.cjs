 ...
 * security levels, and module formats. All constants are exported using CommonJS
 * module.exports for compatibility with require() syntax.
 * 
 * @module constants
 */
 ...
 * @readonly
 */
const ZK_PROOF_TYPES = Object.freeze({
 ...
 * @readonly
 */
const PROOF_TYPE_NAMES = Object.freeze({
 ...
 * @readonly
 */
const MODULE_FORMATS = Object.freeze({
