...
// Use requireJS-style import with fallback
let secureKeyManager;
try {
  secureKeyManager = require('./SecureKeyManager.js');
} catch (e) {
  // Mock for testing
  secureKeyManager = {
    encryptPrivateKey: async () => 'encrypted',
    decryptPrivateKey: async () => 'decrypted',
