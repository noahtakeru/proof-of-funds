/**
 * Re-export file for zkErrorLogger
 * 
 * This file is a compatibility layer that provides direct exports
 * from the zkErrorLogger.mjs module.
 * 
 * @module zkErrorLogger
 */

// Import the error handler classes we need
import { ErrorSeverity, ErrorCategory, ZKError } from './zkErrorHandler.js';
...
/**
 * Singleton instance of the ZKErrorLogger.
 * Provides a pre-configured logger for use throughout the application.
 * 
 * @type {ZKErrorLogger}
 */
...
/**
 * Default export for the error logger.
 * Provides the zkErrorLogger singleton and related constants
