...
test('Implementation Vulnerability Detector exists', () => {
    const filePath = 'lib/zk/src/security/detectors/ImplementationVulnerabilityDetector.cjs';
    const requiredStrings = [
...
test('CryptoVerificationRule exists', () => {
    const filePath = 'lib/zk/src/security/rules/CryptoVerificationRule.cjs';
    const requiredStrings = [
...
test('PrivilegeEscalationRule exists', () => {
    const filePath = 'lib/zk/src/security/rules/PrivilegeEscalationRule.cjs';
    const requiredStrings = [
...
test('Anomaly Detector exists', () => {
    const filePath = 'lib/zk/src/security/detectors/AnomalyDetector.cjs';
    const requiredStrings = [
...
test('SecurityDetectorFactory includes AnomalyDetector', () => {
    const filePath = 'lib/zk/src/security/detectors/SecurityDetectorFactory.cjs';
    const requiredStrings = [
        'AnomalyDetector',
...
test('SecurityRuleRunner exists', () => {
    const filePath = 'lib/zk/src/security/SecurityRuleRunner.cjs';
    const requiredStrings = [
