 ...
 */
const getEthers = exports.getEthers = async () => {
    if (!ethersInstance) {
        try {
 ...
 */
const isValidAmount = exports.isValidAmount = (amount) => {
 ...
 */
const parseUnits = exports.parseUnits = async (value, decimals = 18) => {
    try {
 ...
 */
const parseEther = exports.parseEther = async (value) => {
    try {
        const { ethers, isV5, isV6 } = await getEthers();
 ...
 */
const formatUnits = exports.formatUnits = async (value, decimals = 18) => {
    try {
        const { ethers, isV5, isV6 } = await getEthers();
 ...
 */
const fallbackParseUnits = exports.fallbackParseUnits = (value, decimals = 18) => {
    if (!value) return '0';
 ...
 */
const fallbackFormatUnits = exports.fallbackFormatUnits = (value, decimals = 18) => {
    if (!value) return '0';
 ...
 */
const parseAmount = exports.parseAmount = async (amount, decimals = 18) => {
    try {
