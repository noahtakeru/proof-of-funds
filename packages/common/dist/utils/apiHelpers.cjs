 ...
 */
const executeWithRetry = exports.executeWithRetry = async (apiCallFn, maxRetries = 3, initialDelay = 1000) => {
  let attempt = 0;
  let lastError;
 ...
 */
const rateLimitStats = exports.rateLimitStats = {
  moralis: { 
    limitHits: 0, 
    lastHit: null,
    remainingQuota: null
 ...
 */
const createErrorResponse = exports.createErrorResponse = (operation, error, chain = '') => {
  return {
    error: true,
 ...
 */
const processAllSettledResults = exports.processAllSettledResults = (results, keys, operation) => {
  const successes = {};
  const errors = {};
 ...
 */
const chainScanningOrder = exports.chainScanningOrder = [
