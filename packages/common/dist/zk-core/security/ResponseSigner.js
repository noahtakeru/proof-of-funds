...
function signResponse(responseData, options = {}) {
    ...
    try {
        ...
        const signature = generateSignature({ ...signedResponse, _security: { ..._security, signature: undefined } }, _security.algorithm);
...
function verifySignedResponse(signedResponse) {
    ...
    try {
        ...
        const expectedSignature = generateSignature(responseForVerification, _security.algorithm || DEFAULT_ALGORITHM);
