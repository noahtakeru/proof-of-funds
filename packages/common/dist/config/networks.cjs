...
// Polygon Networks
const POLYGON_NETWORKS = exports.POLYGON_NETWORKS = {
...
const DEFAULT_NETWORK = exports.DEFAULT_NETWORK = 'AMOY';

// Export a helper for getting current network settings
const getNetworkConfig = exports.getNetworkConfig = (networkKey = DEFAULT_NETWORK) => {
