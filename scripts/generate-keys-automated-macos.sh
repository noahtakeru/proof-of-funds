...
# macOS version with automated secure entropy generation

echo "===== ZK Keys Generation Script (macOS Automated) ====="
echo "🔐 Generating cryptographically secure entropy automatically..."

# Generate secure entropy using macOS-compatible script
source ./scripts/generate-secure-entropy-macos.sh
